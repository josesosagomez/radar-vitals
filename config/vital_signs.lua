...
file_path = string.gsub(file_path, "custom_capture.lua","");
...
--ADC_Data file path
data_path     = "C:\\ti\\mmwave_studio_02_01_01_00\\mmWaveStudio\\PostProc"
...
if((partId == 1642) or (partId == 1843)) then
    if(ar1.ProfileConfig(0, 77, 7, 5, 57, 0, 0, 0, 0, 0, 0, 70.006, 0, 256, 5209, 0, 0, 30) == 0) then
...
if (ar1.FrameConfig(0, 0, 1200, 32, 50, 0, 0, 1) == 0) then
