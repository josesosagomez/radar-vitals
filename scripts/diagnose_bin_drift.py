...
# The AHET window-outcome classifier and its constants were moved to
# src/m4/outcome.py (M8 Step 1b plan section 4.1) so a third caller could import them
# without importing this executable script. Re-exported here so this module's public
# surface is unchanged for existing callers and tests.
from src.m4.outcome import (  # noqa: E402
    ...
    RESP_GATE_LO_HZ,
    _f_r_in_gate,
    _is_trailing_suffix_of_not_attempted,
